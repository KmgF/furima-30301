class User < ApplicationRecord
  ...
  devise :database_authenticatable, :registerable,
    ...
    # validates :first_name, format: { with: /\A[ぁ-んァ-ン一-龥]/, message: '漢字、ひらがな、全角カタカナのみ使用できます' }
    # validates :family_name, format: { with: /\A[ぁ-んァ-ン一-龥]/, message: '漢字、ひらがな、全角カタカナのみ使用できます' }
    # validates :first_name_kana, format: { with: /\A[ァ-ヶー－]+\z/, message: '全角カタカナのみ使用できます' }
    # validates :family_name_kana, format: { with: /\A[ァ-ヶー－]+\z/, message: '全角カタカナのみ使用できます' }
